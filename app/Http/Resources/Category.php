...
//        pd($this->whenLoaded('category_tags')->toArray(),'$this->whenLoaded(\'categoryTags\')');

        $response['category_tags'] = $this->whenLoaded('category_tags') ? Tag::collection($this->category_tags) : [];
        return $response;
    }
}
